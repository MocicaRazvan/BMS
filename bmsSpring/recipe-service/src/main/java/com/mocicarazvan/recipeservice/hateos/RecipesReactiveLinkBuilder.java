...
public class RecipesReactiveLinkBuilder extends ApproveReactiveLinkBuilder<Recipe, RecipeBody, RecipeResponse, RecipeRepository, RecipeMapper,
    ...
    public List<WebFluxLinkBuilder.WebFluxLink> createModelLinks(RecipeResponse recipeResponse, Class<RecipeController> c) {
        ...
        links.add(WebFluxLinkBuilder.linkTo(WebFluxLinkBuilder.methodOn(c).createWithVideos(null, null, null, null)).withRel("createWithVideos"));
        links.add(WebFluxLinkBuilder.linkTo(WebFluxLinkBuilder.methodOn(c).updateWithVideos(null, null, null, null, null)).withRel("updateWithVideos"));
