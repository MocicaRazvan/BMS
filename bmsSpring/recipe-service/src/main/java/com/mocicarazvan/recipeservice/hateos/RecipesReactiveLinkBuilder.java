...
public class RecipesReactiveLinkBuilder extends ApproveReactiveLinkBuilder<Recipe, RecipeBody, RecipeResponse, RecipeRepository, RecipeMapper,
    ...
    public List<WebFluxLinkBuilder.WebFluxLink> createModelLinks(RecipeResponse recipeResponse, Class<RecipeController> c) {
        ...
        links.add(WebFluxLinkBuilder.linkTo(WebFluxLinkBuilder.methodOn(c).getAllModelsFiltered(null, null, null, null, null, null, null, null, null, null)).withRel("getAllModelsFiltered"));
        links.add(WebFluxLinkBuilder.linkTo(WebFluxLinkBuilder.methodOn(c).getAllModelsFilteredWithCount(null, null, null, null, null, null, null, null, null, null)).withRel("getModelsFilteredWithCount"));
        links.add(WebFluxLinkBuilder.linkTo(WebFluxLinkBuilder.methodOn(c).getAllModelsFilteredWithUser(null, null, null, null, null, null, null, null, null, null)).withRel("getAllModelsFilteredWithUser"));
        ...
        links.add(WebFluxLinkBuilder.linkTo(WebFluxLinkBuilder.methodOn(c).getModelsTrainerFiltered(null, null, null, null, null, null, null, null, null, null)).withRel("getModelsTrainerFiltered"));
        links.add(WebFluxLinkBuilder.linkTo(WebFluxLinkBuilder.methodOn(c).getModelsTrainerFilteredWithCount(null, null, null, null, null, null, null, null, null, null)).withRel("getModelsTrainerFilteredWithCount"));
