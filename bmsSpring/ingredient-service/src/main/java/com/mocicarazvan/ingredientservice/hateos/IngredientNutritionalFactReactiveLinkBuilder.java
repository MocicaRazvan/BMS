...
public class IngredientNutritionalFactReactiveLinkBuilder implements ReactiveLinkBuilder<IngredientNutritionalFactResponse, IngredientNutritionalFactController> {
    ...
    public List<WebFluxLinkBuilder.WebFluxLink> createModelLinks(IngredientNutritionalFactResponse ingredientNutritionalFactResponse, Class<IngredientNutritionalFactController> c) {
        ...
        links.add(WebFluxLinkBuilder.linkTo(WebFluxLinkBuilder.methodOn(c).getModelsFiltered("", true, null, null, null, null, null, null, null, null)).withRel(LinkRelation.of("getFiltered")));
        ...
        links.add(WebFluxLinkBuilder.linkTo(WebFluxLinkBuilder.methodOn(c).getAllModelsFilteredWithEntityCount("", true, null, null, null, null, null, null, null, null)).withRel(LinkRelation.of("getAllModelsFilteredWithEntityCount")));
        return links;
    }
}
