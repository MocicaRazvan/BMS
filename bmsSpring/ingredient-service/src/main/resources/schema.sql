...
(
    ...
    saturated_fat NUMERIC NOT NULL CHECK
(
    saturated_fat
    >=
    0
...
(
    ...
    carbohydrates NUMERIC NOT NULL CHECK
(
    carbohydrates
    >=
    0
),
    sugar NUMERIC NOT NULL CHECK
(
    sugar
    >=
    0
...
(
    ...
    protein NUMERIC NOT NULL CHECK
(
    protein
    >=
    0
),
    salt NUMERIC NOT NULL CHECK
(
    salt
    >=
    0
...
(
    ...
    ingredient_id BIGINT NOT NULL UNIQUE REFERENCES ingredient
(
    id
) ON DELETE CASCADE
    CHECK
