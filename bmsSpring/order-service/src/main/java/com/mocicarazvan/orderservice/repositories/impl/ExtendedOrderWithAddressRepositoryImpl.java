...
public class ExtendedOrderWithAddressRepositoryImpl implements ExtendedOrderWithAddressRepository {
    ...
    private void appendWhereClause(StringBuilder queryBuilder, String city, String state, String country,
        ...
        repositoryUtils.addStringField(city, queryBuilder, hasPreviousCriteria, " ( city ILIKE '%' || :city || '%' OR city % :city )");
        repositoryUtils.addStringField(state, queryBuilder, hasPreviousCriteria, "( state ILIKE '%' || :state || '%' OR state % :state )");
        repositoryUtils.addStringField(country, queryBuilder, hasPreviousCriteria, "( country ILIKE '%' || :country || '%' OR country % :country )");
