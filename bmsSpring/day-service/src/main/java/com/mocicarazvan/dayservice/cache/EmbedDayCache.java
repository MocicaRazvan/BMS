...
@Component
public class EmbedDayCache extends SaveObjectToCacheImpl implements EmbedCache {
    @Value("${spring.custom.ollama.cache.expire.minutes:5}")
    private Long expireMinutes;

    public EmbedDayCache(ReactiveRedisTemplate<String, Object> reactiveRedisTemplate,
    ...
    public Mono<OllamaEmbedResponseModel> getEmbedding(String text, Function<String, OllamaEmbedResponseModel> cacheMissFunction) {
        return getOrSaveObject(text, expireMinutes, cacheMissFunction, (t) -> getEmbeddingKey("dayEmbedding", t), new TypeReference<>() {
        });
    }
}
