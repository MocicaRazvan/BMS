...
public class DayReactiveLinkBuilder extends TitleBodyReactiveLinkBuilder<
    ...
    public List<WebFluxLinkBuilder.WebFluxLink> createModelLinks(DayResponse dayResponse, Class<DayController> c) {
        ...
        links.add(WebFluxLinkBuilder.linkTo(WebFluxLinkBuilder.methodOn(c).getDaysFiltered(null, null, null, null, null)).withRel("getDaysFiltered"));
        links.add(WebFluxLinkBuilder.linkTo(WebFluxLinkBuilder.methodOn(c).getDaysFilteredWithCount(null, null, null, null, null)).withRel("getDaysFilteredWithCount"));
        links.add(WebFluxLinkBuilder.linkTo(WebFluxLinkBuilder.methodOn(c).getDaysFilteredWithUser(null, null, null, null, null)).withRel("getDaysFilteredWithUser"));
