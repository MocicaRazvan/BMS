...
public class PlansReactiveLinkBuilder extends ApproveReactiveLinkBuilder<
    ...
    public List<WebFluxLinkBuilder.WebFluxLink> createModelLinks(PlanResponse planResponse, Class<PlanController> c) {
        ...
        links.add(WebFluxLinkBuilder.linkTo(WebFluxLinkBuilder.methodOn(c).getAllPlansFiltered(null, null, null, null, null, null, null, null, null)).withRel("getPlansFiltered"));
        links.add(WebFluxLinkBuilder.linkTo(WebFluxLinkBuilder.methodOn(c).getAllPlansFilteredWithCount(null, null, null, null, null, null, null, null, null)).withRel("getPlansFilteredWithCount"));
        links.add(WebFluxLinkBuilder.linkTo(WebFluxLinkBuilder.methodOn(c).getAllPlansFilteredWithUser(null, null, null, null, null, null, null, null, null)).withRel("getPlansFilteredWithUser"));
