...
@Component
public class EmbedPostCache extends SaveObjectToCacheImpl implements EmbedCache {
    @Value("${spring.custom.ollama.cache.expire.minutes:5}")
    private Long expireMinutes;

    public EmbedPostCache(ReactiveRedisTemplate<String, Object> reactiveRedisTemplate,
    ...
    public Mono<OllamaEmbedResponseModel> getEmbedding(String text, Function<String, OllamaEmbedResponseModel> cacheMissFunction) {
        return getOrSaveObject(text, expireMinutes, cacheMissFunction, (t) -> getEmbeddingKey("postEmbedding", t), new TypeReference<>() {
        });
    }
}
