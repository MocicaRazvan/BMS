...
export default function TestPageContent() {
  ...
  //     fields: [
  //       { content: description, name: "description", isHtml: true },
  //       { content: type, name: "type", isHtml: false },
  //     ],
  //   });
  //   setIsLoading(false);
  ...
  // }, [input]);
  return (
    <div className="w-full h-full flex items-center justify-center min-h-52 p-20">
      <Popover>
        <PopoverTrigger asChild>
          <Button variant="outline">AI</Button>
        </PopoverTrigger>
        {/*<PopoverContent className="shadow-md shadow-shadow_color">*/}
        {/*  <p> Ask ai for help you can add a short desc for help</p>*/}
        {/*  <div>*/}
