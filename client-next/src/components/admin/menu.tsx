...
import { AdminMenuTexts, getMenuList } from "@/components/admin/menu-list";
import { CollapseMenuButton } from "@/components/admin/collpase-menu-button";
...
export function Menu({ isOpen, texts }: MenuProps) {
  const pathname = usePathname();
  const menuList = getMenuList(pathname, texts);
