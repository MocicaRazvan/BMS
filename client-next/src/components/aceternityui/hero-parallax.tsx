...
const HeroParallax = memo(
  ({
    ...
    return (
      <div
        ref={ref}
        className="h-[240vh] py-40 overflow-hidden  antialiased relative flex flex-col self-auto [perspective:1000px] [transform-style:preserve-3d] !transform-gpu"
      >
        <Header {...texts} />
        <motion.div
          style={{
...
export const ProductCard = ({
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 h-full w-full opacity-0 group-hover/product:opacity-70 bg-black pointer-events-none" />
